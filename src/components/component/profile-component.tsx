...
* @see https://v0.dev/t/wMmTjD0YaZO
              ...
              <Card>
                ...
                <CardContent className="grid gap-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Textarea id="description" placeholder="Enter blog post description" rows={3} />
                  </div>
                  <div className="grid gap-2">
                    ...
                    <Table>
                      ...
                      <TableBody>
                        <TableRow>
                          ...
                          <TableCell>Exploring the latest trends and technologies in web development.</TableCell>
                          <TableCell>
                            <img
                              src="/placeholder.svg"
                              width={64}
                        ...
                        <TableRow>
                          <TableCell className="font-medium">Mastering React Hooks</TableCell>
                          <TableCell>A comprehensive guide to using React Hooks effectively.</TableCell>
                          <TableCell>
                            <img
                              src="/placeholder.svg"
                              width={64}
                        ...
                        <TableRow>
                          <TableCell className="font-medium">Designing Accessible Websites</TableCell>
                          <TableCell>Tips and best practices for creating inclusive and accessible websites.</TableCell>
                          <TableCell>
                            <img
                              src="/placeholder.svg"
                              width={64}
